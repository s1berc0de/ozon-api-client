...
func TestAttribute_Success(t *testing.T) {
	...
	resp, httpResp, err := c.Attribute(context.Background(), &attribute.AttributeRequest{})
	require.Nil(t, err)
	require.NotNil(t, httpResp)
	require.Equal(t, httpResp.StatusCode, http.StatusOK)
	require.EqualValues(t, &attribute.AttributeResponse{
		Result: []attribute.AttributeResult{
			{
